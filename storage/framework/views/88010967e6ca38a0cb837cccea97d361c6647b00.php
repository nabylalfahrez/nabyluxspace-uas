<header class="<?php echo e(\Route::current()->getName()=='index' ? 'absolute' : ''); ?> w-full z-50 px-4">
          ...
          <div class="w-auto">
            ...
            >
              <li class="mx-3 py-6 md:py-0">
                <a href="#" class="<?php echo e(\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                  >Showcase</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
              ...
              <li class="mx-3 py-6 md:py-0">
                <a href="<?php echo e(route('dashboard.index')); ?>" class="<?php echo e(\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                  >Dashboard</a
                >
              </li>
              <?php endif; ?>
              ...
              <li class="mx-3 py-6 md:py-0">
                <a href="<?php echo e(route('login')); ?>" class="<?php echo e(\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                  >Login</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
                <a href="<?php echo e(route('register')); ?>" class="<?php echo e(\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                  >Register</a
                >
              </li>
              <?php endif; ?>
          ...
          <div class="w-auto">
            <ul class="items-center flex">
              <li class="ml-6 block md:hidden">
                <button
                  id="menu-toggler"
                  class="relative flex z-50 items-center justify-center w-8 h-8 text-black <?php echo e(\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'); ?>"
                >
                  <svg
                    class="fill-current"
                    width="18"
    ...
    </header><?php /**PATH C:\laragon\www\luxspace\resources\views/components/frontend/navbar.blade.php ENDPATH**/ ?>