              ...
              >
                ...
                <div class="px-4 w-auto flex-1 md:w-5/12">
                  <div class="">
                    ...
                    >
                      IDR <?php echo e(number_format($item->product->price)); ?>
                ...
                >
                  <div class="">
                    <h6 class="font-semibold text-lg">IDR <?php echo e(number_format($item->product->price)); ?></h6>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\luxspace\resources\views/pages/frontend/cart.blade.php ENDPATH**/ ?>