          ...
          <div class="w-auto">
            ...
            >
              <li class="mx-3 py-6 md:py-0">
                <a href="#" class="{{\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'}} hover:underline"
                  >Showcase</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
              ...
              @auth
              <li class="mx-3 py-6 md:py-0">
                <a href="{{route('dashboard.index')}}" class="{{\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'}} hover:underline"
                  >Dashboard</a
                >
              </li>
              @endauth
              @guest
              <li class="mx-3 py-6 md:py-0">
                <a href="{{route('login')}}" class="{{\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'}} hover:underline"
                  >Login</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
                <a href="{{route('register')}}" class="{{\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'}} hover:underline"
                  >Register</a
                >
              </li>
              @endguest
          ...
          <div class="w-auto">
            <ul class="items-center flex">
              <li class="ml-6 block md:hidden">
                <button
                  id="menu-toggler"
                  class="relative flex z-50 items-center justify-center w-8 h-8 text-black {{\Route::current()->getName()=='index' ? 'md:text-white' : 'md:text-black'}}"
                >
                  <svg
                    class="fill-current"
                    width="18"
